...
9. [Geocomputation with R](https://r.geocompx.org/) by Robin Lovelace, Jakub Nowosad and  Jannes Muenchow 

   This book covers geographic data analysis, visualization, and modeling techniques
   
10. The [`ceylon` R package](https://github.com/thiyangt/ceylon) by Thiyanga Talagala 
